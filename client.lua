...
-- Eventos genericos csWatermark (cualquier script puede usarlos)
-- TriggerEvent('cswatermark:hide')
-- TriggerEvent('cswatermark:show')
RegisterNetEvent('cswatermark:hide', hideLogo)
RegisterNetEvent('cswatermark:show', showLogo)
...
RegisterCommand('wmdebug', function()
    debug = not debug
    print('[cs_watermark] Debug:', debug and 'ON' or 'OFF')
end, false)
